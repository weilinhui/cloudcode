...
public class UserBean {
    ...
    private Long fPersonalShopid;

    private Integer fUserIdentity;
    ...
    public Long getfPersonalShopid() {
        return fPersonalShopid;
    }

    public void setfPersonalShopid(Long fPersonalShopid) {
        this.fPersonalShopid = fPersonalShopid;
    }

    public Integer getfUserIdentity() {
        return fUserIdentity;
    }

    public void setfUserIdentity(Integer fUserIdentity) {
        this.fUserIdentity = fUserIdentity;
    }
}